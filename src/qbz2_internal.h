/*
 * libqbz2 - High-performance bzip2 compression library
 * Internal header - types, constants, and macros
 */

#ifndef QBZ2_INTERNAL_H
#define QBZ2_INTERNAL_H
...
/*-- Memory allocation via bz_stream hooks --*/
...
#define BZ_DECODE_TABLE_BITS 11
...
typedef
   struct {
      ...
      Int32    decode_overflow[BZ_N_GROUPS][512];
      Int32    decode_overflow_used[BZ_N_GROUPS];
...
/*-- Decompression function declarations --*/
...
#endif /* QBZ2_INTERNAL_H */

/*-- Handle NULL when BZ_NO_STDIO is defined --*/
